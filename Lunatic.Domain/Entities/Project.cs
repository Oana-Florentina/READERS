...
namespace Lunatic.Domain.Entities {
    public class Project : AuditableEntity {
        ...
        public List<string> TaskSections { get; private set; } = new List<string>();
        ...
        public void AddTaskSection(string section) => TaskSections.Add(section);
        public void RemoveTaskSection(string section) => TaskSections.Remove(section);
